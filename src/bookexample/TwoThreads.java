...
public class TwoThreads {
    ...
    public static void main(String[] args) throws InterruptedException {
        Thread firstThread = new UserInteraction2();
        firstThread.start();
        Thread secondThread = new ComputeLog2();
        secondThread.start();
        firstThread.join();
        ((ComputeLog2) secondThread).end();
    }
}

class UserInteraction2 extends Thread {
...
class ComputeLog2 extends Thread {
